...
const ProjectDetails = () => {
  ...
  const handleCreateTask = async () => {
    ...
    try {
      const response = await taskApi.create(projectId, {
        ...
        assignedTo: taskForm.assignedTo && taskForm.assignedTo !== 'unassigned' ? taskForm.assignedTo : undefined,
  ...
  const openEditTaskDialog = (task: Task) => {
    ...
    setTaskForm({
      ...
      assignedTo: typeof task.assignedTo === 'object' ? task.assignedTo?.id || 'unassigned' : task.assignedTo || 'unassigned',
